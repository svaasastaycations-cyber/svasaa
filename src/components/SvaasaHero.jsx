  ...
  const slides = [
    {
      ...
      altTag: "Farm House Near Me",
      subcaption:
        "Handpicked stays designed for comfort, privacy, and unforgettable moments",
      highlight: "Staycations",
    },
    {
      image: cricketHero,
      caption: "Box Cricket. Snookers. Vibes",
      altTag: "Farm House for Rent in Hyderabad",
      subcaption:
        "Play, unwind, and soak in the perfect blend of fun and relaxation",
      highlight: "Vibes",
    },
    {
      image: poolHero,
      caption: "Dive into Paradise",
      altTag: "Farmhouse with Swimming Pool for Rent in Hyderabad",
      subcaption:
        "Refresh, relax, and indulge in your own private poolside escape",
      highlight: "Paradise",
    },
    {
      image: coupleHero,
      caption: "Couple-Crafted Luxury Stays",
      altTag: "Private Farm House for Rent in Hyderabad",
      subcaption:
        "Intimate spaces thoughtfully designed for meaningful moments together",
      highlight: "Luxury Stays",
    },
    {
      image: petsHero,
      caption: "Get Your Pets Along",
      altTag: "Famous Farm House in Hyderabad",
    ...
    },
    {
      ...
      altTag: "Farm House for Party in Hyderabad",
      subcaption:
        "Warm nights, good conversations, and memories that linger longer",
      highlight: "Bonfire",
    },
  ];
  ...
  const renderCaption = (caption, highlight) => {
    ...
    return parts.map((part, i) =>
      part.toLowerCase() === highlight.toLowerCase() ? (
        <span key={i} className="text-svaasa-brand italic">
          {part}
        </span>
      ) : (
        part

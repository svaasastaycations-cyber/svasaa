      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="space-y-16 md:space-y-32">
          {events.map((event, idx) => (
            <div key={idx} className={`flex flex-col lg:flex-row items-center gap-8 lg:gap-20 ${idx % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
        ...
        <div className="mt-20 md:mt-40 bg-svaasa-card p-6 md:p-16 rounded-3xl shadow-2xl border border-white/10 relative overflow-hidden">
          ...
          <div className="text-center mb-12 md:mb-16 relative z-10">
            <h3 className="text-2xl md:text-5xl font-header font-black tracking-widest text-svaasa-brand mb-6">Event Pricing</h3>
            <p className="text-svaasa-gray font-light max-w-2xl mx-auto text-lg leading-relaxed">
              Our pricing includes the Farmstay, Event lawns, and all amenities at the property—offering you a complete, seamless experience.
            </p>
          </div>
            ...
            <table className="w-full text-center border-collapse min-w-[600px] md:min-w-0">
              <thead>
                <tr className="bg-white/5 text-white font-header font-black uppercase tracking-widest text-[10px] md:text-xs border-b border-white/10">
                  <th className="p-6 md:p-8 border-r border-white/10 text-left">Property</th>
                  <th className="p-6 md:p-8 border-r border-white/10">50 Pax</th>
                  <th className="p-6 md:p-8 border-r border-white/10">100 Pax</th>
                  <th className="p-6 md:p-8 border-r border-white/10">150 Pax</th>
                  <th className="p-6 md:p-8">250 Pax</th>
                </tr>
              </thead>
              <tbody className="text-white font-header font-bold text-sm md:text-lg">
                <tr className="border-b border-white/10 hover:bg-white/5 transition-colors">
                  <td className="p-6 md:p-8 font-black uppercase tracking-widest text-xs md:text-sm bg-white/5 border-r border-white/10 text-left whitespace-nowrap">The Old Town</td>
                  <td className="p-6 md:p-8 border-r border-white/10">₹ 38,000/-</td>
                  <td className="p-6 md:p-8 border-r border-white/10">₹ 60,000/-</td>
                  <td className="p-6 md:p-8 border-r border-white/10">₹ 75,000/-</td>
                  <td className="p-6 md:p-8">₹ 1,00,000/-</td>
                </tr>
                <tr className="hover:bg-white/5 transition-colors">
                  <td className="p-6 md:p-8 font-black uppercase tracking-widest text-xs md:text-sm bg-white/5 border-r border-white/10 text-left whitespace-nowrap">Lotus Bliss</td>
                  <td className="p-6 md:p-8 border-r border-white/10">₹ 34,000/-</td>
                  <td className="p-6 md:p-8 border-r border-white/10">₹ 55,000/-</td>
                  <td className="p-6 md:p-8 border-r border-white/10">₹ 68,000/-</td>
                  <td className="p-6 md:p-8 text-white/10 italic font-medium uppercase text-xs">N/A</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="mt-12 md:mt-16 max-w-4xl mx-auto space-y-6 relative z-10">
            <h4 className="font-serif font-black uppercase tracking-widest text-lg md:text-xl text-white mb-4">Important Information</h4>
            <div className="bg-white/5 p-6 md:p-8 rounded-2xl border border-white/10 space-y-6 text-svaasa-gray font-light text-base md:text-lg leading-relaxed">
               <div className="flex items-start space-x-4">
                 <span className="text-white mt-1 shrink-0 bg-white/10 px-2 rounded-full border border-white/10 text-[10px]">1</span>
                 <p>We offer complete wedding packages, fully customizable to your preferences. We also provide Catering, Decor and Photography services through reliable sources.</p>
               </div>
               <div className="flex items-start space-x-4">
                 <span className="text-white mt-1 shrink-0 bg-white/10 px-2 rounded-full border border-white/10 text-[10px]">2</span>
                 <p>An additional fee of ₹1,000/- per steward for the night will apply if services are required during the stay. <span className="italic text-white/40 block mt-1">(optional, only if you opt for this service)</span></p>
               </div>
               <div className="flex items-start space-x-4">
                 <span className="text-white mt-1 shrink-0 bg-white/10 px-2 rounded-full border border-white/10 text-[10px]">3</span>
                 <p>Cleaning fee of ₹2,000/- will be charged for Haldi events and any other events that require excessive cleaning.</p>
               </div>
               <div className="flex items-start space-x-4">
                 <span className="text-white mt-1 shrink-0 bg-white/10 px-2 rounded-full border border-white/10 text-[10px]">4</span>
                 <p>Tent house items are also available for rent. Prices subject to availability.</p>
               </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20 md:mt-32 bg-svaasa-card border border-white/10 text-white p-8 md:p-24 text-center rounded-3xl relative overflow-hidden shadow-[0_0_50px_rgba(255,255,255,0.03)]">
          ...
          <h3 className="text-2xl md:text-5xl font-serif font-black uppercase tracking-widest mb-8 leading-tight">Ready to plan your event?</h3>
          <p className="text-svaasa-gray mb-12 max-w-2xl mx-auto font-light leading-relaxed text-base md:text-lg">
            Our team is here to assist you with every detail, from selecting the right farmstay to tailoring the space perfectly for your guests.
          </p>
          <button onClick={() => navigate('/contact')} className="bg-white text-svaasa-black px-12 py-5 font-black tracking-widest hover:bg-white/80 transition-all rounded-full shadow-[0_0_20px_rgba(255,255,255,0.2)]">

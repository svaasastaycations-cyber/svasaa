...
import { MapPin, BedDouble, PartyPopper, Wifi, Shield, Zap, Utensils, Waves, Trophy, Users, Sun, Tv, Bath, Gamepad2, Flame, ShowerHead, ChevronLeft, ChevronRight } from 'lucide-react';
        ...
        <section className="pt-20 pb-12 border-b border-white/10 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto">
            <div className="flex flex-col items-center group">
              ...
              <span className="text-xl md:text-2xl font-bold text-svaasa-brand leading-tight">Just 15 mins from ORR</span>
            </div>
            <div className="flex flex-col items-center group">
              <div className="w-20 h-20 rounded-full bg-white/5 border border-white/10 flex items-center justify-center mb-6 group-hover:bg-svaasa-brand group-hover:text-black transition-all duration-500">
                <BedDouble size={32} strokeWidth={1.5} />
              </div>
              <span className="text-xl md:text-2xl font-bold text-svaasa-brand leading-tight">4 European Themed Luxury Rooms</span>
            </div>
            <div className="flex flex-col items-center group">
              <div className="w-20 h-20 rounded-full bg-white/5 border border-white/10 flex items-center justify-center mb-6 group-hover:bg-svaasa-brand group-hover:text-black transition-all duration-500">
                <Users size={32} strokeWidth={1.5} />
              </div>
              <span className="text-xl md:text-2xl font-bold text-svaasa-brand leading-tight">Upto 20 guests</span>
            </div>
          </div>
        </section>
        ...
        <section className="pt-20 pb-12 border-b border-white/10 text-center">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-lg md:text-2xl text-svaasa-gray font-header font-light leading-relaxed space-y-6 md:space-y-10 italic">
              <p>
                Lotus Bliss is a <strong className="text-svaasa-brand">European-themed luxury villa just 15 min from ORR</strong>—close to the city, yet secluded for complete privacy. With <strong className="text-svaasa-brand">4 elegantly designed bedrooms</strong>, a spacious living room for cozy movie nights, and a <strong className="text-svaasa-brand">terrace overlooking a serene lake view</strong>, it offers the perfect blend of comfort and style.
              </p>
              <p>
                From relaxing in the <strong className="text-svaasa-brand">poolside gazebo</strong> and taking a dip in the pool to enjoying <strong className="text-svaasa-brand">box cricket and bonfire evenings</strong>, every moment here feels special. Ideal for family get-togethers and intimate celebrations, it also features an <strong className="text-svaasa-brand">event space for up to 200 guests</strong>. It’s not just a stay—it feels like home, only better.
              </p>
            </div>
          </div>
        </section>
            ...
            <table className="w-full text-center border-collapse min-w-[500px] md:min-w-0">
              ...
              <tbody className="text-white font-header">
                <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
                  <td className="p-6 md:p-8 text-left text-lg md:text-2xl font-light">Upto 10 Guests</td>
                  <td className="p-6 md:p-8 text-right text-lg md:text-2xl font-light">₹ 20,000/-</td>
                  <td className="p-6 md:p-8 text-right text-lg md:text-2xl font-light">₹ 23,000/-</td>
                </tr>
                <tr className="hover:bg-white/5 transition-colors">
                  <td className="p-6 md:p-8 text-left text-lg md:text-2xl font-light">From 10-20 Guests</td>
                  <td className="p-6 md:p-8 text-right text-lg md:text-2xl font-light">₹ 23,000/-</td>
